			...
			<div class="container">
				<div class="row">
					...
					<div class="col-sm-6">				
						...
						<form class="center" role="form" action="<?php echo base_url(); ?>index.php/data_ruang/simpan_ubah_data_ruang" method="post">	
							<fieldset>
								...
								<div class="form-group">
									<button class="btn btn-success btn-md btn-block">Simpan Perubahan Data Ruang</button>
								</div>
							</fieldset>
						</form>
					</div>
